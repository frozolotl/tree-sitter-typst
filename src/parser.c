...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [27] = {.lex_state = 19, .external_lex_state = 5},
  [28] = {.lex_state = 19, .external_lex_state = 5},
  [29] = {.lex_state = 19, .external_lex_state = 5},
  [30] = {.lex_state = 19, .external_lex_state = 5},
  [31] = {.lex_state = 1, .external_lex_state = 7},
  [32] = {.lex_state = 1, .external_lex_state = 7},
  [33] = {.lex_state = 1, .external_lex_state = 7},
  [34] = {.lex_state = 1, .external_lex_state = 7},
  [35] = {.lex_state = 1, .external_lex_state = 7},
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [4] = {
    [sym__markup_expr_base] = STATE(19),
    [sym__markup_expr_text] = STATE(19),
    [sym_link] = STATE(19),
    [sym_label] = STATE(19),
    [sym_block_comment] = STATE(19),
    [sym__space_no_newline] = STATE(19),
    [aux_sym__markup_no_newline_repeat1] = STATE(4),
    [ts_builtin_sym_end] = ACTIONS(53),
    [aux_sym__markup_expr_text_token1] = ACTIONS(55),
    [sym_linebreak] = ACTIONS(58),
    [sym_escape] = ACTIONS(58),
    [sym_shorthand] = ACTIONS(58),
    [sym_smart_quote] = ACTIONS(58),
    [aux_sym_link_token1] = ACTIONS(61),
    [anon_sym_LT] = ACTIONS(64),
    [sym_line_comment] = ACTIONS(58),
    [anon_sym_SLASH_STAR] = ACTIONS(67),
    [aux_sym__space_no_newline_token1] = ACTIONS(58),
    [sym_space] = ACTIONS(53),
    [sym_parbreak] = ACTIONS(53),
    [sym_raw] = ACTIONS(58),
    [sym_text] = ACTIONS(58),
    [sym__delim_strong] = ACTIONS(53),
    [sym__delim_emph] = ACTIONS(53),
    [sym_heading_start] = ACTIONS(53),
  },
  [5] = {
    [sym__markup_expr_base] = STATE(19),
    [sym__markup_expr_text] = STATE(19),
    ...
    [sym_shorthand] = ACTIONS(70),
    [sym_smart_quote] = ACTIONS(70),
    [aux_sym_link_token1] = ACTIONS(70),
    [anon_sym_LT] = ACTIONS(70),
    [sym_line_comment] = ACTIONS(70),
    [anon_sym_SLASH_STAR] = ACTIONS(70),
    [aux_sym__space_no_newline_token1] = ACTIONS(74),
    [sym_space] = ACTIONS(70),
    [sym_parbreak] = ACTIONS(70),
    [sym_raw] = ACTIONS(70),
    [sym_text] = ACTIONS(70),
    [sym__delim_strong] = ACTIONS(70),
    [sym__delim_emph] = ACTIONS(70),
    [sym_heading_start] = ACTIONS(70),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markup_repeat1, 2), SHIFT_REPEAT(51),
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markup_repeat1, 2), SHIFT_REPEAT(50),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markup_repeat1, 2), SHIFT_REPEAT(37),
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markup_repeat1, 2), SHIFT_REPEAT(10),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markup_repeat1, 2), SHIFT_REPEAT(13),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_markup_repeat1, 2), SHIFT_REPEAT(40),
  ...
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__markup_no_newline_repeat1, 2),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__markup_no_newline_repeat1, 2), SHIFT_REPEAT(19),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_no_newline_repeat1, 2), SHIFT_REPEAT(19),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_no_newline_repeat1, 2), SHIFT_REPEAT(51),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_no_newline_repeat1, 2), SHIFT_REPEAT(50),
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_no_newline_repeat1, 2), SHIFT_REPEAT(37),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__markup_no_newline, 1, .production_id = 1),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__markup_no_newline, 1, .production_id = 1),
  ...
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__markup_strong_repeat1, 2), SHIFT_REPEAT(24),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 2), SHIFT_REPEAT(24),
  [100] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 2), SHIFT_REPEAT(42),
  [103] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 2), SHIFT_REPEAT(52),
  [106] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 2), SHIFT_REPEAT(35),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 2),
  [111] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 2), SHIFT_REPEAT(7),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__markup_strong, 1, .production_id = 1),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__markup_emph, 1, .production_id = 1),
  [118] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__markup_emph_repeat1, 2), SHIFT_REPEAT(23),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 2), SHIFT_REPEAT(23),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 2), SHIFT_REPEAT(42),
  [127] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 2), SHIFT_REPEAT(52),
  [130] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 2), SHIFT_REPEAT(35),
  [133] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 2), SHIFT_REPEAT(6),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 2),
  [138] = {.entry = {.count = 1, .reusable = false}}, SHIFT(19),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_comment, 3),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3, .production_id = 4),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_label, 3, .production_id = 4),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_link, 2),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_link, 2),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_comment, 2),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__markup_no_newline_repeat1, 1),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__markup_no_newline_repeat1, 1),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_strong, 3, .production_id = 2),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_strong, 3, .production_id = 2),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_heading, 3, .production_id = 3),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_heading, 3, .production_id = 3),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_emph, 3, .production_id = 2),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_emph, 3, .production_id = 2),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__markup_emph_repeat1, 1),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__markup_emph_repeat1, 1),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__markup_strong_repeat1, 1),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__markup_strong_repeat1, 1),
  ...
  [204] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(36),
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(32),
  [210] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(36),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2),
