...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym__markup_expr] = sym__markup_expr,
  [sym_label] = sym_label,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (sym_ident_character_set_1(lookahead)) ADVANCE(34);
    ...
    case 5:
      ...
      if (sym_link_character_set_1(lookahead)) ADVANCE(30);
      END_STATE();
    case 6:
    ...
    case 20:
      ...
      END_STATE();
    case 21:
      if (aux_sym_label_token1_character_set_1(lookahead)) ADVANCE(32);
      END_STATE();
    case 22:
      if (eof) ADVANCE(23);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_parbreak] = ACTIONS(11),
    [sym_raw] = ACTIONS(5),
    [sym_text] = ACTIONS(5),
  },
  [2] = {
    [sym__markup_expr] = STATE(3),
    [sym_label] = STATE(3),
    ...
    [sym_shorthand] = ACTIONS(15),
    [sym_smart_quote] = ACTIONS(15),
    [sym_link] = ACTIONS(15),
    [anon_sym_LT] = ACTIONS(7),
    [sym_line_comment] = ACTIONS(15),
    [anon_sym_SLASH_STAR] = ACTIONS(9),
    [sym_whitespace] = ACTIONS(17),
    [sym_parbreak] = ACTIONS(17),
    [sym_raw] = ACTIONS(15),
    [sym_text] = ACTIONS(15),
  },
  [3] = {
    ...
    [sym_whitespace] = ACTIONS(30),
    [sym_parbreak] = ACTIONS(30),
    [sym_raw] = ACTIONS(21),
    [sym_text] = ACTIONS(21),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [24] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(14),
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2),
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_comment, 2),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3, .production_id = 1),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_label, 3, .production_id = 1),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_comment, 3),
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(9),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(10),
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(9),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2),
