...
enum {
  ...
  aux_sym_block_comment_repeat1 = 15,
};
...
static inline bool aux_sym_block_comment_token1_character_set_1(int32_t c) {
  return (c < 43514
    ? (c < 4193
      ? (c < 2707
        ? (c < 1994
...
static inline bool sym_text_character_set_3(int32_t c) {
  return (c < '<'
    ? (c < '"'
      ? (c < '\t'
        ? c == 0
...
static inline bool sym_text_character_set_4(int32_t c) {
  return (c < '<'
    ? (c < '\''
      ? (c < '\t'
        ? c == 0
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 11 ||
          ...
          lookahead == 133 ||
          lookahead == 8232 ||
          lookahead == 8233) ADVANCE(7);
      if (aux_sym_block_comment_token1_character_set_1(lookahead)) ADVANCE(11);
    ...
    case 2:
      ...
      if (('\n' <= lookahead && lookahead <= '\f')) ADVANCE(21);
    ...
    case 4:
      ...
      if (sym_line_comment_character_set_1(lookahead)) ADVANCE(5);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(4);
      END_STATE();
    case 5:
    ...
    case 11:
      ACCEPT_TOKEN(aux_sym_block_comment_token1);
      if (sym_ident_character_set_1(lookahead)) ADVANCE(14);
      END_STATE();
    case 12:
    ...
    case 17:
      ...
      if (!sym_text_character_set_3(lookahead)) ADVANCE(18);
      END_STATE();
    case 18:
      ACCEPT_TOKEN(sym_text);
      if (!sym_text_character_set_4(lookahead)) ADVANCE(18);
      END_STATE();
    case 19:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(6),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(7),
  [48] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2), SHIFT_REPEAT(6),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2),
  ...
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_comment, 2),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_comment, 3),
